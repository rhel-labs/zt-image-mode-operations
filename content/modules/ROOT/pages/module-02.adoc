...
==== _Click on the tab labeled "Operations VM"_ 
...
NOTE: Rebooting will disconnect your tab from the ops-vm system, simply wait about 30 seconds and press the 'reconnect' button in the center of the terminal to re-establish your session
